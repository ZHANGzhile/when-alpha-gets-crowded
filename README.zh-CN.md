...
- 历史成分事件还需独立来源交叉核验；
- 5/10 日提前量、Crash 事件研究、M2/M3 placebo-context、26/52周错位和判别效度已经具备受协议门保护的生产入口；连续伪策略的100条稳定成员、收益账本、leave-one-out结构C、同口径G/S状态及逐策略成熟LS Outcome已实现，伪策略Prediction比较以及控制器生产运行仍待完成。
