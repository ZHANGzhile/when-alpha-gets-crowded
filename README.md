...
- Protocol-gated entry points now cover 5/10-session leads, crash event studies, M2/M3 placebo context, 26/52-week misalignment, and discriminant validity. Stable membership, return ledgers, and leave-one-out structural C are implemented for 100 continuous pseudo-strategies; their G/S, outcome, and prediction path and the production controller remain open.
